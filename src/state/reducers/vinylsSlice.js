    ...
    initialState: {
        vinyls: [
            ...
            },
            {
                ...
                title: 'AT.LONG.LAST.AAP',
                price: '37.99',
                id: 54,
                des: `At. Long. Last. ASAP (stylized as AT.LONG.LAST.AAP) is the second studio album by American rapper ASAP Rocky. It was released on May 26, 2015, by ASAP Worldwide, Polo Grounds Music, and RCA Records. The record serves as a sequel from Rocky's previous studio effort Long. Live. ASAP (2013). The album's executive production was provided by Danger Mouse, mentor ASAP Yams and Rocky himself, featuring production by Rocky and Danger Mouse, as well as a variety of several high-profile producers, including co-executive producers Hector Delgado and Juicy J, Jim Jonsin, FnZ, Frans Mernick, Kanye West, Thelonious Martin, and Mark Ronson, among others. The album features guest appearances from Bones, Joe Fox, Future, Schoolboy Q, Kanye West, Lil Wayne, and A-Cyde, among others.`
            },
            {
                genre: 'Hip-Hop/Rap',
                artist: 'Pop Smoke',
